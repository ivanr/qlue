 ...
 * URI that was used to reach it (e.g., /pageName.html?_pid=12345678),
 ...
 * used, a redirection will be issued to it.
 */
public class FinalRedirectView extends RedirectView {
	
	/**
	 * Create final redirection to a page.
	 * 
	 * @param page
	 */
	...
	/**
	 * Create final redirection to a URI.
	 * 
	 * @param toUri
	 */
